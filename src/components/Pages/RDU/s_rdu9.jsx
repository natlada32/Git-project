...
const headers = [
  "หน่วยบริการ",
  {
    title: "ข้อมูลแฟ้ม LABOR",
    children: ["B", "A", "ร้อยละ"]
  },
  {
    title: "ข้อมูลแฟ้ม DIAG_IPD",
    children: ["B", "A", "ร้อยละ"]
  }
];

export default function S_rdu9() {
          ...
          <div className="container mx-auto px-5 py-10">
            ...
            <div className="my-8 bg-white p-6 rounded-lg shadow-md border border-gray-200">
                <h2 className="text-lg font-semibold text-gray-800 mb-6">
                    กราฟแสดงร้อยละการใช้ยาปฏิชีวนะในหญิงคลอดปกติครบกำหนดทางช่องคลอด ระดับโรงพยาบาล (APL) ประจำปีงบประมาณ {selectedYear}
                </h2>
            ...
            <div className="w-full overflow-x-auto shadow-md rounded-lg">
              <h2 className="text-lg font-semibold text-gray-600 mb-4">ร้อยละการใช้ยาปฏิชีวนะในหญิงคลอดปกติครบกำหนดทางช่องคลอด ระดับโรงพยาบาล (APL)</h2>
              ...
              <div className='p-2 text-xs text-left font-semibold text-green-600'>B หมายถึง จำนวนครั้งของสตรีคลอดปกติครบกำหนด(ท่าศรีษะ)ทั้งหมด</div>
              <div className='p-2 text-xs text-left font-semibold text-green-600'>A หมายถึง จำนวนครั้งของสตรีคลอดปกติครบกำหนด(ท่าศรีษะ) ที่ได้รับยาปฏิชีวนะ</div>
            </div>
          </div>
          <Footer />  
    </> 
