...
export default function S_rdu12() {
        ...
        <div className="container mx-auto px-5 py-10">
          ...
          <div className="my-8 bg-white p-6 rounded-lg shadow-md border border-gray-200">
            <h2 className="text-lg font-semibold text-gray-800 mb-6">
              ร้อยละของผู้ป่วยนอกโรคเบาหวานที่ใช้ยา metformin เป็นยาชนิดเดียวหรือร่วมกับยาอื่นเพื่อควบคุมระดับน้ำตาล โดยไม่มีข้อห้ามใช้ ปีงบประมาณ {selectedYear}
            </h2>
            {loading ? (
          ...
          <div className="w-full overflow-x-auto shadow-md rounded-lg">
            ...
            <div className="p-2 text-xs text-left font-semibold text-green-600">
              B หมายถึง จำนวนผู้ป่วยนอกโรคเบาหวานชนิดที่ 2 ทั้งหมด และมีผล lab ล่าสุดย้อนหลัง 12 เดือน eGFR ≥ 30 ml/min/1.73 m2
            </div>
            <div className="p-2 text-xs text-left font-semibold text-green-600">
              A หมายถึง จำนวนผู้ป่วยนอกโรคเบาหวานชนิดที่ 2 ที่ใช้ยา metformin เป็นยาชนิดเดียวหรือร่วมกับยาอื่นเพื่อควบคุมระดับน้ำตาล และมีผล lab ล่าสุดย้อนหลัง 12 เดือน eGFR ≥ 30 ml/min/1.73 m2
            </div>
          </div>
        </div>
        <Footer />
