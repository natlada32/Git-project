...
export default function S_rdu16() {
        ...
        <div className="container mx-auto px-5 py-10">
          ...
          <div className="my-8 bg-white p-6 rounded-lg shadow-md border border-gray-200">
            <h2 className="text-lg font-semibold text-gray-800 mb-6">
              ร้อยละผู้ป่วยนอกสูงอายุที่ใช้ยากลุ่ม long-acting benzodiazepine ได้แก่ chlordiazepoxide, diazepam, dipotassium chlorazepate ปีงบประมาณ {selectedYear}
            </h2>
            {loading ? (
          ...
          <div className="w-full overflow-x-auto shadow-md rounded-lg">
            ...
            <div className="p-2 text-xs text-left font-semibold text-green-600">
              B หมายถึง จำนวนครั้งการมารับบริการผู้ป่วยนอกของผู้ป่วยสูงอายุในช่วงเวลาที่เก็บข้อมูล
            </div>
            <div className="p-2 text-xs text-left font-semibold text-green-600">
              A หมายถึง จำนวนครั้งการมารับบริการของผู้ป่วยสูงอายุ (visit) ที่ได้ยา
            </div>
          </div>
        </div>
        <Footer />
