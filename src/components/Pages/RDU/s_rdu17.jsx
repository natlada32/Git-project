...
export default function S_rdu17() {
        ...
        <div className="container mx-auto px-5 py-10">
          ...
          <div className="my-8 bg-white p-6 rounded-lg shadow-md border border-gray-200">
            <h2 className="text-lg font-semibold text-gray-800 mb-6">
              จำนวนสตรีตั้งครรภ์ที่ได้รับยาที่ห้ามใช้ ได้แก่ยา Warfarin หรือ Statins หรือ Ergots เมื่อรู้ว่าตั้งครรภ์แล้ว ปีงบประมาณ {selectedYear}
            </h2>
            {loading ? (
          ...
          <div className="w-full overflow-x-auto shadow-md rounded-lg">
            ...
            <div className="p-2 text-xs text-left font-semibold text-green-600">
              B หมายถึง จำนวนสตรีตั้งครรภ์ที่มารับบริการ จากแฟ้ม DIAGNOSIS_OPD และแฟ้ม ANC
            </div>
            <div className="p-2 text-xs text-left font-semibold text-green-600">
              A หมายถึง จำนวนสตรีตั้งครรภ์ที่ได้รับยาที่ห้ามใช้ ได้แก่ warfarin หรือ ยากลุ่ม statins หรือยากลุ่ม ergots ยกเว้นกรณีใส่ mechanical heart valve และได้รับยา warfarin
            </div>
          </div>
        </div>
        <Footer />
